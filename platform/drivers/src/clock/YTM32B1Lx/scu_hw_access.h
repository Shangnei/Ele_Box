...
{
    uint32_t regValue = base->FXOSC_CTRL;
    regValue &= (uint32_t)(~(SCU_FXOSC_CTRL_FXOSC_DLY_SEL_MASK));
    regValue |= (uint32_t)SCU_FXOSC_CTRL_FXOSC_DLY_SEL(delay);
    base->FXOSC_CTRL = regValue;
}
...
{
    uint32_t regValue = base->FXOSC_CTRL;
    regValue &= (uint32_t)(~(SCU_FXOSC_CTRL_FXOSC_GAIN_SEL_MASK));
    regValue |= (uint32_t)SCU_FXOSC_CTRL_FXOSC_GAIN_SEL(gain);
    base->FXOSC_CTRL = regValue;
}
...
#if FEATURE_SCU_CMU_SUPPORT_REF_CLOCK_SEL
/*!
